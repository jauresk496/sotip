...
const DOC_TYPES = [
  {
    ...
    icon: "bi-cash-stack",
    color: "#a0c83c",
    desc: "Entrées et sorties de caisse",
  },
  {
    type: "recu",
    label: "Reçu",
    icon: "bi-receipt",
    color: "#1e5a78",
    desc: "Reçus de paiement clients",
  },
  {
    type: "bon_sortie",
    label: "Bon de Sortie",
    ...
    color: "#143c50",
    desc: "Sorties de matériel / marchandises",
  },
];
  ...
  return (
    <AdminShell>
      <div className="page-head">
        <div>
          <h1 className="ph-title">Gestion SOTIP-CI</h1>
            ...
            <div className="adm-card-body" style={{ padding: "1.25rem 1.5rem" }}>
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                ...
                <div style={{ display: "flex", gap: ".4rem" }}>
                  <Link href={`/admin/gestion/${dt.type}`} className="btn-outline-sotip" style={{ padding: ".35rem .8rem", fontSize: ".78rem", textDecoration: "none" }}>
                    Voir
                  </Link>
                  <Link href={`/admin/gestion/${dt.type}?new=1`} className="btn-sotip" style={{ padding: ".35rem .8rem", fontSize: ".78rem", textDecoration: "none" }}>
        ...
        <div className="adm-card-body" style={{ padding: 0, overflowX: "auto" }}>
          <table className="adm-table">
            ...
            <tbody>
                ...
                <tr key={doc.id}>
                  ...
                  <td>
                    <div style={{ display: "flex", gap: ".35rem" }}>
                      <Link
                        href={`/admin/gestion/imprimer/${doc.id}`}
                        target="_blank"
                        className="btn-sotip"
                      ...
                      <Link
                        href={`/admin/gestion/${doc.doc_type}`}
              ...
              {loading && (
                <tr>
                  <td colSpan={5} style={{ textAlign: "center", padding: "2rem", color: "#6b7c8a" }}>Chargement...</td>
                </tr>
              )}
            </tbody>
          </table>
